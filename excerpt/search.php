...
<div id="post-search-<?php the_ID() ?>" <?php post_class('search'); ?>>
	...
	<p class="by-line alt-font tight">
		...
		<span class="date"><span class="ndash">&ndash;</span> <abbr class="published" title="<?php the_time('Y-m-d\TH:i'); ?>"><?php the_time('F j, Y'); ?></abbr></span>
	</p>
